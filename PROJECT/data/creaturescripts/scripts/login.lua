...
-- 	if getPlayerStorageValue(cid, 898309) < 1 then
-- 		db.executeQuery("INSERT INTO player_storage VALUES ("..getPlayerGUID(cid)..", "..ZE_isOnZombieArea.." , 0 );")
-- setPlayerStorageValue(cid,898309,1)
-- end
